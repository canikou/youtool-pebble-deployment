...
from yt_assist.bot.render import contracts_embed, help_action_rows, help_page_embed, pricesheet_embed
from yt_assist.domain.catalog import Catalog
from yt_assist.domain.contracts import Contracts
from yt_assist.domain.templates import TemplateLoadStatus, initialize as initialize_templates
...
def _load_current_snapshot() -> dict:
    ...
    return {
        ...
        "observable_surfaces": {
            "help_pages": [help_page_embed("yt!", page).to_dict() for page in range(4)],
